...
import com.example.soda.R;
import com.example.soda.audio.AudioMessageManager;
        ...
        switch (action){
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!isRecording || mTime < 0.9f){
                    ...
                    if (mListener != null){
                        mListener.onAudioRecorderFinish(mTime,mAudioManger.getCurrentFilePath());
                    }
